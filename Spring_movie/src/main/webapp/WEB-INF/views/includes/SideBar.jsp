...
<!-- SideBar.jsp -->    
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center  justify-content-center" href="${pageContext.request.contextPath }/MovieMainPage">
                <div class="sidebar-brand-icon rotate-n-15"><i class="fas fa-laugh-wink"></i></div>
                <div class="sidebar-brand-text mx-3 font-red">Movie</div>
            </a>
            ...
            <li class="nav-item active">
                <a class="nav-link" href="${pageContext.request.contextPath }/MovieMainPage">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                       ...
                       <c:choose>
                        ...
                        <a class="collapse-item" href="MovieList">영화차트</a>
                        <a class="collapse-item" href="MovieReservationPage">영화예매</a>
                        <a class="collapse-item" href="ReservationList">예매내역</a>
                        </c:otherwise>
                        </c:choose>
            ...
            <li class="nav-item">
                ...
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="ChatPageTest">채팅테스트</a>
